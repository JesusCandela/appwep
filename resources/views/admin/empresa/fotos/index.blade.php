...
<body>
    <div class="container">
        <div class="row">
            @include('admin.menu')
            <div class="col-sm-10">
            <a href="{{ route('fotosEmpresaAdmin.create') }}" class="btn btn-success">NUEVA FOTO</a>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <img src="/img/foto/{{ $item->urlfoto }}" style="max-width: 100px; max-height: 150px !important;" />
                            ...
                            <td class= "align-middle">
                                <a href="{{ route('fotosEmpresaAdmin.edit', $item->id) }}" class="btn btn-primary custom-btn edit-btn"><i class="fas fa-edit"></i>EDITAR</a>
